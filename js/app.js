...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Tu voulais mettre OUI nan ?🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "T'as pas fait exprès de cliquer je crois🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "Aller stp je vais pleurer sinon 😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    text.innerHTML = "Aller s'il te plait 🥺😘";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Je le savais 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/eliott_bdn_prv/?next=%2F" target ="_blank">Envoie moi un petit message mdrrr</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
